...
const JobDetails = () => {
  ...
  const handleFormSubmission = async e=>{
    ...
    if(price< parseFloat(min_price)) return toast.error('Offer more or at least niminum price')
    ...
    const bidData = { jobId,price,comment,email,buyer,status,job_title,category,deadline}
